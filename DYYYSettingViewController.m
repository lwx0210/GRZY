...
- (void)setupSettingItems {
    self.settingSections = @[
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"自定弹幕颜色" key:@"DYYYdanmuColor" type:DYYYSettingItemTypeTextField placeholder:@"random"],
            ...
            [DYYYSettingItem itemWithTitle:@"属地时间颜色" key:@"DYYYLabelColor" type:DYYYSettingItemTypeTextField placeholder:@"rainbow"],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"设置推荐标题" key:@"DYYYModifyTopTabText" type:DYYYSettingItemTypeTextField placeholder:@"#推荐,DYYY"],
        ...
        @[
            ...
            [DYYYSettingItem itemWithTitle:@"隐藏搜索指示" key:@"DYYYHideSearchEntranceIndicator" type:DYYYSettingItemTypeSwitch],
